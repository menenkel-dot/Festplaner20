  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans transition-all antialiased">
      ...
      <div className="flex flex-1 relative">
        ...
        <aside className={`fixed inset-y-0 left-0 z-40 transform lg:static lg:translate-x-0 w-64 bg-white border-r border-slate-200 flex flex-col p-6 shrink-0 transition-transform duration-300 ease-in-out ${
          ...
          <nav aria-label="Hauptnavigation" className="min-h-0 flex-1 overflow-y-auto pr-1">
            <section aria-labelledby="sidebar-master-data-title" className="space-y-1.5">
              <h2 id="sidebar-master-data-title" className="px-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Stammdaten
              </h2>
            ...
            <section aria-labelledby="sidebar-functions-title" className="mt-5 space-y-1.5 border-t border-slate-200 pt-4">
              <h2 id="sidebar-functions-title" className="px-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Funktionen
              </h2>
          ...
          <button
            ...
            className={`${!hasPermission("users") ? "hidden" : "flex"} items-center justify-between px-3.5 py-2.5 rounded-lg font-semibold text-xs text-left transition-all ${
              activeTab === "users" 
                ? "bg-blue-50 text-blue-700 font-bold" 
                : "text-slate-600 hover:bg-slate-50 hover:text-slate-900"
            }`}
